...
public class CatalogoLivros {
    ...
    // Metodo de pesquisa por Intervalo de Anos
    ...
    // Metodo de pesquisa por Titulos
    ...
    // Main para executar e testar os metodos
    public static void main(String[] args) {
        ...
        catalogoLivros.adicionarLivro("Livro 5", "Autor 5", 1996);
